...
% EffectiveArea - функция вычисления площади под графиком кривой, заданной точками.
% Функция вычисляет площадь только тех сегментов, где координата Х точек кривой
% стремиться к нулю. Кривая задаётся векторами х и у. Вектор х хранит координату Х точек.
...
function [ area ] = EffectiveArea( x, y )
    area = 0;
    for i = 2 : length(x)
